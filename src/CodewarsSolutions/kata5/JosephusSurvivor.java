...
will be used, using an array/list to compute the number of the survivor may be too slow; you may assume that both n and k will always be >=1.
 */
...
public class JosephusSurvivor {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(josephusSurvivor(1000, 2));
