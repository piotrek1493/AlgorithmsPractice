...
/*
data and data1 are two strings with rainfall records of a few cities for months from January to December. The records of
towns are separated by \n. The name of each town is followed by :.

data and towns can be seen in "Your Test Cases:".

Task:
function: mean(town, strng) should return the average of rainfall for the city town and the strng data or data1 (In R and
...
public class Rainfall {
    ...
    public static double mean(String town, String strng) {
        ...
        if (weatherData.isEmpty()) return -1;

        return weatherData.stream().mapToDouble(i -> i).sum() / weatherData.size();
    }
    ...
    public static List<Double> getData(String str) {
        String[] array = str.replaceAll("[A-Za-z: ]", "").split(",");
        return Arrays.stream(array).mapToDouble(Double::valueOf).boxed().collect(Collectors.toList());
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(variance("Beijing", data));
        System.out.println(mean("Rome", data));
        System.out.println(variance("Rome", data));
        System.out.println();
        System.out.println(mean("aaa", data));
        System.out.println(variance("aaa", data));
    }
}
