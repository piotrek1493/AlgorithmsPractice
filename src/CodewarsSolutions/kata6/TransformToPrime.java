...
/*
Task :
Given a List [] of n integers , find minimum mumber to be inserted in a list, so that sum of all elements of list should
...
public class TransformToPrime {
    ...
    public static void main(String[] args) {
        ...
        int[] test1 = {3, 1, 2};
        int[] test2 = {2, 12, 8, 4, 6};
        int[] test3 = {50, 39, 49, 6, 17, 28};
        System.out.println(minimumNumber(test1));
        System.out.println(minimumNumber(test2));
        System.out.println(minimumNumber(test3));
