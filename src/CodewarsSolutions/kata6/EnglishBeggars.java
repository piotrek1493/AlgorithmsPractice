...
/*
Your task here is pretty simple: given an array of values and an amount of beggars, you are supposed to return an array
...
public class EnglishBeggars {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(beggars(test1, 2)));
        System.out.println(Arrays.toString(beggars(test1, 3)));
